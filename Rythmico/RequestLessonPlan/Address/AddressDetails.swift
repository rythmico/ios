...
protocol AddressDetailsProtocol {
...
// Address without id
struct AddressDetails: AddressDetailsProtocol, Hashable, Equatable, Codable {
    var latitude: Double
...
extension AddressDetails: Identifiable {
    var id: Int { hashValue }
}

extension AddressDetailsProtocol {
