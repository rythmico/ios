...
final class InstrumentProviderFake: InstrumentProviderProtocol {
    func instruments(completion: Handler<[Instrument]>) {
        let instruments = [
            ...
            Instrument(id: "DRUMS", name: "Drums", icon: Image(decorative: "instrument-icon-guitar")),
            Instrument(id: "PIANO", name: "Piano", icon: Image(decorative: "instrument-icon-guitar")),
            Instrument(id: "SINGING", name: "Singing", icon: Image(decorative: "instrument-icon-guitar"))
        ]
